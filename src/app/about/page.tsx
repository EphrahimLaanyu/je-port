      ...
      <main className="px-6 md:px-12 lg:px-24 pb-32">
        ...
        <section className="fade-section max-w-4xl mx-auto text-center py-24">
          ...
          <p className="animate-text font-serif text-3xl md:text-5xl leading-tight text-balance">
            We are not just a digital agency. We are a <span className="italic text-[#4a0404]">tri-force</span> collective. 
            Merging deep-system architecture, precision code, and the psychology of branding.
          </p>
        </section>
        ...
        <section className="fade-section py-24">
          <div className="flex flex-col gap-32">
            ...
            {/* 1. MOSES (Left Aligned) */}
            <div className="flex flex-col md:flex-row items-start justify-between group">
              <div className="w-full md:w-1/3 mb-8 md:mb-0">
                 <span className="animate-text font-mono text-[10px] tracking-[0.4em] uppercase block opacity-40 mb-2">01 / The Foundation</span>
                 <h2 className="animate-text font-serif text-6xl md:text-7xl leading-none mb-2">Moses <br/> Chengo</h2>
                 <p className="animate-text font-mono text-xs text-[#4a0404] tracking-widest uppercase mt-4">Lead Backend Developer</p>
              </div>
              <div className="w-full md:w-1/2 relative">
                 ...
                 <p className="animate-text font-serif text-2xl md:text-3xl italic leading-relaxed pl-8 border-l border-[#4a0404]">
                   &quot;True power is silent. I architect the invisible systems that hold the world together while the interface takes the bow.&quot;
                 </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-start justify-between group">
              <div className="w-full md:w-1/3 mb-8 md:mb-0 text-right">
                 <span className="animate-text font-mono text-[10px] tracking-[0.4em] uppercase block opacity-40 mb-2">02 / The Vision</span>
            ...
            {/* 3. EPHRAHIM (Left Aligned - Zigzag) */}
            <div className="flex flex-col md:flex-row items-start justify-between group">
              <div className="w-full md:w-1/3 mb-8 md:mb-0">
                 <span className="animate-text font-mono text-[10px] tracking-[0.4em] uppercase block opacity-40 mb-2">03 / The Engine</span>
                 <h2 className="animate-text font-serif text-6xl md:text-7xl leading-none mb-2">Ephrahim <br/> Laanyu</h2>
                 <p className="animate-text font-mono text-xs text-[#4a0404] tracking-widest uppercase mt-4">Lead Frontend Developer</p>
              </div>
              <div className="w-full md:w-1/2 relative">
                 <div className="animate-text absolute -left-8 -top-8 text-9xl font-serif text-[#0a0a0a]/5 select-none">“</div>
                 <p className="animate-text font-serif text-2xl md:text-3xl italic leading-relaxed pl-8 border-l border-[#4a0404]">
        ...
        <section className="fade-section py-24">
          <div className="flex flex-col md:flex-row gap-12">
            ...
            <div className="w-full md:w-2/3 grid grid-cols-1 gap-12">
              {[
                { title: "System Architecture", desc: "Database / Security / Scalability" },
                { title: "Brand Strategy", desc: "Positioning / Voice / Visual Identity" },
                { title: "Web Development", desc: "React / Next.js / Performance / GSAP" },
