  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const handleMouseMove = (e: MouseEvent) => {
        ...
        const expansion = distFromCenterX * 25; 
        ...
        <div className="w-full md:w-1/2 h-full relative flex items-center justify-center p-6 md:p-12 md:pt-24">
          <div className="glass-panel relative w-full h-[70vh] md:h-[75vh] bg-white/5 backdrop-blur-2xl border border-white/30 rounded-[2px] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.08)] flex items-center justify-center overflow-hidden cursor-none">
            ...
            <div className="relative z-10 flex items-center justify-center w-full max-w-lg scale-90 md:scale-100">
              ...
              {/* Left Wing */}
              <div ref={leftWingRef} className="w-32 md:w-56 translate-x-[12%] will-change-transform relative h-auto aspect-auto">
                <Image 
                  src="/assets/logo-beige.png"
                  alt="Maison Wing Left" 
                  // REQUIRED: Add width/height when using string path from public/
                  // Adjust these numbers to match your image's actual aspect ratio
                  width={800}
                  height={800}
              ...
              {/* Right Wing */}
              <div ref={rightWingRef} className="w-32 md:w-56 -translate-x-[12%] scale-x-[-1] will-change-transform relative h-auto aspect-auto">
                <Image 
                  src="/assets/logo-burgundy.png" 
                  alt="Maison Wing Right" 
                  // REQUIRED: Add width/height here as well
                  width={800}
                  height={800}
                  className="w-full h-auto drop-shadow-[0_20px_50px_rgba(0,0,0,0.15)]"
                  priority
